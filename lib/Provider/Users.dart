...
Future<dynamic> getFieldById(String fieldName, String id) async {
  try {
    ...
    DocumentSnapshot documentSnapshot = await FirebaseFirestore.instance.collection('Bdeals_Users').doc(id).get();
...
Future<void> AddUserToFirebase(String username, String email, String pass, int noWA) async {
  final CollectionReference users = FirebaseFirestore.instance.collection('Bdeals_Users');
